  ...
  return (
    <section className="surface-card space-y-4">
      ...
      <div className="flex flex-wrap items-center gap-2">
        <button
          type="button"
          className={`segment-button px-3 py-1.5 text-xs ${selectedTab === "outcomes" ? "bg-[var(--primary)]/10 text-[var(--primary)]" : ""}`}
        ...
        <button
          type="button"
          className={`segment-button px-3 py-1.5 text-xs ${selectedTab === "templates" ? "bg-[var(--primary)]/10 text-[var(--primary)]" : ""}`}
