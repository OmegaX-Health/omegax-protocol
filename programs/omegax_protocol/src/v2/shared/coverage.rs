...
pub(crate) fn validate_policy_series_fields(
    ...
    require!(
        ...
        OmegaXProtocolV2Error::PolicySeriesNameTooLong
    );
    require!(
        metadata_uri.len() <= MAX_METADATA_URI_LEN,
        OmegaXProtocolV2Error::PolicySeriesMetadataUriTooLong
    );
    require!(
        duration_secs > 0,
        OmegaXProtocolV2Error::PolicySeriesDurationInvalid
    );
    require!(
        premium_due_every_secs > 0 && premium_grace_secs >= 0,
        OmegaXProtocolV2Error::PolicySeriesPremiumScheduleInvalid
    );
    require!(premium_amount > 0, OmegaXProtocolV2Error::InvalidAmount);
    Ok(())
}
...
pub(crate) fn require_policy_series_active(product: &PolicySeries) -> Result<()> {
    require!(
        ...
        OmegaXProtocolV2Error::PolicySeriesInactive
    );
    Ok(())
}
...
pub(crate) fn validate_policy_series_matches_policy(
    ...
    require!(
        ...
        OmegaXProtocolV2Error::PolicySeriesPolicyMismatch
    );
    require!(
...
pub(crate) fn validate_policy_position_window(
    ...
    require!(
        starts_at < ends_at,
        OmegaXProtocolV2Error::InvalidCoverageWindow
    );
    require!(
        premium_due_every_secs > 0,
        OmegaXProtocolV2Error::InvalidPremiumSchedule
    );
    require!(
...
pub(crate) fn require_coverage_active(policy: &PolicyPosition, now: i64) -> Result<()> {
    require!(
        ...
        OmegaXProtocolV2Error::CoverageNotActive
    );
    require!(
    ...
    require!(
        ...
        OmegaXProtocolV2Error::PremiumDelinquent
    );
