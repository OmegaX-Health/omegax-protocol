...
pub fn create_pool_v2(
    ...
    require!(
        !ctx.accounts.config_v2.emergency_paused,
        OmegaXProtocolV2Error::ProtocolPaused
    );
    require!(
        pool_id.len() <= MAX_POOL_ID_LEN,
        OmegaXProtocolV2Error::PoolIdTooLong
    );
    require!(
        organization_ref.len() <= MAX_ORG_REF_LEN,
        OmegaXProtocolV2Error::OrganizationRefTooLong
    );
    require!(
        payout_lamports_per_pass > 0,
        OmegaXProtocolV2Error::InvalidAmount
    );
    require!(
        ...
        OmegaXProtocolV2Error::InvalidMembershipMode
    );
    require!(
    ...
    require!(
        ...
        OmegaXProtocolV2Error::InvalidPoolType
    );
    if membership_mode == MEMBERSHIP_MODE_TOKEN_GATE {
        require!(
            token_gate_mint != ZERO_PUBKEY,
            OmegaXProtocolV2Error::InvalidMembershipConfiguration
        );
        require!(
...
pub fn set_pool_status(ctx: Context<SetPoolStatus>, status: u8) -> Result<()> {
    require!(
        ...
        OmegaXProtocolV2Error::InvalidPoolStatus
    );
...
pub fn set_pool_oracle_policy(
    ...
    require!(quorum_m > 0, OmegaXProtocolV2Error::InvalidQuorum);
    require!(quorum_n > 0, OmegaXProtocolV2Error::InvalidQuorum);
    require!(quorum_m <= quorum_n, OmegaXProtocolV2Error::InvalidQuorum);
    require!(
        oracle_fee_bps <= MAX_PROTOCOL_FEE_BPS,
        OmegaXProtocolV2Error::InvalidOracleFee
    );
    require!(
        u32::from(ctx.accounts.config_v2.protocol_fee_bps)
...
pub fn set_pool_coverage_reserve_floor(
    ...
    require_keys_eq!(
        ...
        OmegaXProtocolV2Error::PolicySeriesAdminUnauthorized
    );
...
pub fn set_pool_risk_controls(
    ...
    require!(
        ...
        OmegaXProtocolV2Error::InvalidPoolRedemptionMode
    );
    require!(
        claim_mode == POOL_CLAIM_MODE_OPEN || claim_mode == POOL_CLAIM_MODE_PAUSED,
        OmegaXProtocolV2Error::InvalidPoolClaimMode
    );
    require!(
    ...
    require!(
        has_pool_risk_authority(
            &ctx.accounts.pool,
            &ctx.accounts.config_v2,
            ctx.accounts.pool_control_authority.as_ref(),
            signer,
        ),
        OmegaXProtocolV2Error::PoolRiskControlUnauthorized
    );
...
pub fn set_policy_series(
    ...
    require!(
        ...
        OmegaXProtocolV2Error::CompliancePolicyUnauthorized
    );
...
pub fn set_pool_compliance_policy(
    ...
    require!(
        ...
        OmegaXProtocolV2Error::InvalidComplianceBindingMode
    );
    require!(
        ...
        OmegaXProtocolV2Error::InvalidComplianceProviderMode
    );
    require!(
        capital_rail_mode <= RAIL_MODE_PERMISSIONED_SPL
            && payout_rail_mode <= RAIL_MODE_PERMISSIONED_SPL,
        OmegaXProtocolV2Error::InvalidRailMode
    );
...
pub fn set_pool_control_authorities(
    ...
    require!(
        signer == ctx.accounts.pool.authority
            || signer == ctx.accounts.config_v2.governance_authority
            || (ctx.accounts.config_v2.emergency_paused && signer == ctx.accounts.config_v2.admin),
        OmegaXProtocolV2Error::ControlAuthorityUnauthorized
    );
...
pub fn set_pool_automation_policy(
    ...
    require!(
        ...
        OmegaXProtocolV2Error::InvalidAutomationMode
    );
    let signer = ctx.accounts.authority.key();
    require!(
        has_pool_compliance_authority(
        ...
        OmegaXProtocolV2Error::AutomationPolicyUnauthorized
    );
...
pub fn register_outcome_schema(
    ...
    require!(
        schema_key.len() <= 64,
        OmegaXProtocolV2Error::SchemaKeyTooLong
    );
    require!(
        metadata_uri.len() <= MAX_METADATA_URI_LEN,
        OmegaXProtocolV2Error::MetadataUriTooLong
...
pub fn verify_outcome_schema(ctx: Context<VerifyOutcomeSchema>, verified: bool) -> Result<()> {
    ...
    let config = &ctx.accounts.config_v2;
...
pub fn backfill_schema_dependency_ledger(
    ...
    for account in ctx.remaining_accounts.iter() {
        ...
        let rule = PoolOutcomeRule::try_deserialize(&mut data_slice)
            .map_err(|_| OmegaXProtocolV2Error::InvalidProgramAccountData)?;
        require!(
...
pub fn close_outcome_schema(ctx: Context<CloseOutcomeSchema>) -> Result<()> {
    ...
    require!(
        ...
        OmegaXProtocolV2Error::SchemaCloseRequiresUnverified
    );
    require!(
    ...
    require!(
        ctx.accounts.schema_dependency.active_rule_refcount == 0,
        OmegaXProtocolV2Error::SchemaRuleReferencesOutstanding
    );
...
pub fn set_policy_series_outcome_rule(
    ...
    if is_existing_rule {
        ...
        require!(
            ...
            OmegaXProtocolV2Error::RuleHashMismatch
        );
        require!(
...
pub fn enroll_member_open(
    ...
    require!(
        ...
        OmegaXProtocolV2Error::PoolNotOpenForEnrollment
    );
    require!(
...
pub fn enroll_member_token_gate(
    ...
    require!(
        ...
        OmegaXProtocolV2Error::TokenGateOwnerMismatch
    );
    require!(
        ctx.accounts.token_gate_account.mint == pool.token_gate_mint,
        OmegaXProtocolV2Error::TokenGateMintMismatch
    );
    require!(
        ctx.accounts.token_gate_account.amount >= pool.token_gate_min_balance,
        OmegaXProtocolV2Error::TokenGateBalanceTooLow
    );
...
pub fn enroll_member_invite_permit(
    ...
    require!(
        ...
        OmegaXProtocolV2Error::InviteIssuerNotActive
    );
    require!(
        pool.invite_issuer == ctx.accounts.issuer.key(),
        OmegaXProtocolV2Error::InviteIssuerMismatch
    );

    let now = Clock::get()?.unix_timestamp;
    require!(now <= expires_at_ts, OmegaXProtocolV2Error::PermitExpired);
...
pub fn fund_pool_sol(ctx: Context<FundPoolSol>, lamports: u64) -> Result<()> {
    require!(lamports > 0, OmegaXProtocolV2Error::InvalidAmount);
...
pub fn fund_pool_spl(ctx: Context<FundPoolSpl>, amount: u64) -> Result<()> {
    require!(amount > 0, OmegaXProtocolV2Error::InvalidAmount);
    require!(
        ctx.accounts.pool_terms.payout_asset_mint != ZERO_PUBKEY,
        OmegaXProtocolV2Error::PayoutAssetNotConfigured
    );
    require!(
...
pub fn initialize_pool_liquidity_sol(
    ...
    require!(initial_lamports > 0, OmegaXProtocolV2Error::InvalidAmount);
    require!(
        ctx.accounts.pool_terms.payout_asset_mint == ZERO_PUBKEY,
        OmegaXProtocolV2Error::InvalidPayoutAssetForLiquidity
    );
...
pub fn initialize_pool_liquidity_spl(
    ...
    require!(initial_amount > 0, OmegaXProtocolV2Error::InvalidAmount);
    require!(
        ctx.accounts.pool_terms.payout_asset_mint != ZERO_PUBKEY,
        OmegaXProtocolV2Error::InvalidPayoutAssetForLiquidity
    );
...
pub fn register_pool_capital_class(
    ...
    require!(
        ...
        OmegaXProtocolV2Error::InvalidCapitalClassMode
    );
    require!(
        ...
        OmegaXProtocolV2Error::InvalidCapitalTransferMode
    );
    require!(
...
pub fn deposit_pool_liquidity_sol(
    ...
    assert_protocol_not_paused(&ctx.accounts.config_v2)?;
    require!(amount_in > 0, OmegaXProtocolV2Error::InvalidAmount);
    require!(
        ctx.accounts.pool_terms.payout_asset_mint == ZERO_PUBKEY,
        OmegaXProtocolV2Error::InvalidPayoutAssetForLiquidity
    );
    ...
    require!(
        ...
        OmegaXProtocolV2Error::LiquidityDepositsDisabled
    );
    ...
    require!(
        ...
        OmegaXProtocolV2Error::SlippageExceeded
    );
...
pub fn deposit_pool_liquidity_spl(
    ...
    require!(
        ...
        OmegaXProtocolV2Error::MissingAssetVault
    );
...
pub fn redeem_pool_liquidity_sol(
    ...
    assert_protocol_not_paused(&ctx.accounts.config_v2)?;
    require!(shares_in > 0, OmegaXProtocolV2Error::InvalidAmount);
    require!(
        ctx.accounts.pool_terms.payout_asset_mint == ZERO_PUBKEY,
        OmegaXProtocolV2Error::InvalidPayoutAssetForLiquidity
    );
    ...
    if let Some(class) = ctx.accounts.pool_capital_class.as_ref() {
        require!(
            ...
            OmegaXProtocolV2Error::PoolRedemptionsQueueOnly
        );
    }
    assert_action_compliant(
        ctx.accounts
...
pub fn request_pool_liquidity_redemption(
    ...
    require!(
        ...
        OmegaXProtocolV2Error::PoolRedemptionsPaused
    );
...
pub fn schedule_pool_liquidity_redemption(
    ...
    require!(
        ...
        OmegaXProtocolV2Error::RedemptionRequestUnauthorized
    );
    let now = Clock::get()?.unix_timestamp;
